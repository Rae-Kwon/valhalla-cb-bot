    ...
    async execute(interaction) {
        if (interaction.commandName === 'help') {
            ...
            const helpEmbed = new MessageEmbed()
                ...
                .addFields({ name: `ヤハロ〜!! ${thisUser.username}!!`, value: "Here's some info about the commands you can use!!"},
                { name: '/attack', value: `This one is for clan battles!! Type in the command and I'll bring up a window where you can type in you attack score!!
                ...
                { name: '/ingamescore', value: `This one is for when you've finished all your hits for the clan battle!! Your ingame score is viewable in Priconne under the in-clan clan battle rankings! 
                ...
                { name: '/currentevents', value: `This command lets you know what events are going on in Priconne!! Crunchyroll did not make it easy for Machu to get the data from so it's coming automatically from their site. If for any reason it looks broken then Crunchyroll are being baka baka's and changed it so you should contact Machu asap!!` },
                ...
                { name: '/announceevents', value: `This is a command that lets me know to remind members with a selected role that an event is about to start or end!
                ...
                { name: '/createsheet', value: `This one is for the mods and admins! You can type in this command and a window will pop up where you will put in the clan battle number! I'll then create a sheet with everyone in it so make sure the role where all the clan battle members are is up to date!! Don't be a baaaaaka` },
                { name: '/setup', value: `This one is for the mods and admins! This is to setup the attack channel and event announcement channel! If you already have both type in this command and type in or paste in the channel ID of what you want the attack and event channel to be. If you don't have either then leave them blank and I will automatically make them for you!!
                ...
                .setFooter({ text: "Any questions or concerns contact Machu!! またね!!" })
