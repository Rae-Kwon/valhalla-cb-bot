  ...
  bot.on('interactionCreate', async (interaction) => {
    ...
    try {
      if (interaction.customId === modalSubmit.name && modalSubmit.onSubmit) {
        ...
        const hasAttackChannelPermission = interaction.guild.me
          .permissionsIn(attackChannel)
          .has(Permissions.FLAGS.VIEW_CHANNEL)
        await modalSubmit.onSubmit(
          interaction,
          attackChannel,
          hasAttackChannelPermission,
          bot
        )
      }
    } catch (error) {
