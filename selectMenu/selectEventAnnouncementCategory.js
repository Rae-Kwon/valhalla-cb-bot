...
module.exports = {
    ...
    async onSelect(interaction, bot, cache) {
        ...
        try {
            ...
            cache[interaction.guildId] = {...cache[interaction.guildId], eventAnnounceChannelId: channelData.id}
            connectDb.connection.close()
        }

        const reply = await interaction.editReply({ content: `${channelData.name} created in the ${categoryName} category!` })
